...
@allure.story("Создание класса, инициализация и нажатие на кнопку Checkout")
class CartPage:
    """
    ...
    @allure.description("эта функция находит кнопку по ID 'checkout' и нажимает на кнопку CHECKOUT")
    def checkout(self):
        """
