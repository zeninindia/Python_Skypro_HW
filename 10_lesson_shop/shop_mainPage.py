...
@allure.story("Создание класса главной страницы магазина, выбор товаров и переход в корзину нажатием на корзину")
class MainPage:
    """
    ...
    @allure.epic("driver")
    @allure.description("инициализация класса, создание драйвера класса, ожидание драйвера 50 сек.")
    ...
    @allure.description("здесь записан список элементов и прописана функция нажатия кнопки 'в корзину'")
    def choose_items(self, element):
        ...
        with allure.step("эта функция нажимает кнопку или кнопки выбранные в test_shop.py"):
    ...
    @allure.description("эта функция нажимает находит кнопку по CSS_SELECTOR, '.shopping_cart_link'"
